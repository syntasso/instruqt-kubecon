...
Operators are different from traditional web apps because rather than an HTTP or grpc request, operators listen to changes of a specified Kubernetes resource. Today you will create both the operator application and a custom resource type for it to react to.
